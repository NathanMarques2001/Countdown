...
var x = setInterval(function () {
    ...
    days < 10 ? (document.getElementById("days").innerHTML = "0" + days) : (document.getElementById("days").innerHTML = days);
    hours < 10 ? (document.getElementById("hours").innerHTML = "0" + hours) : (document.getElementById("hours").innerHTML = hours);
